...
const bridge = {
  ...
  ai: {
    ...
    savePromptDebugRecord: (record) => ipcRenderer.invoke('ai:save-prompt-debug-record', record),
  ...
  knowledgeBase: {
    ...
    importCategorizedArchives: () => ipcRenderer.invoke('knowledge-base:import-categorized-archives'),
  ...
  imageKnowledgeBase: {
    ...
    importHistoricalArchives: (section) => ipcRenderer.invoke('image-knowledge-base:import-historical-archives', section),
    importCategorizedArchives: () => ipcRenderer.invoke('image-knowledge-base:import-categorized-archives'),
  ...
  aiEvaluation: {
    ...
    exportCommitteeReport: (options) => ipcRenderer.invoke('ai-evaluation:export-committee-report', options),
  ...
  bidDocument: {
    loadState: () => ipcRenderer.invoke('bid-document:load-state'),
    saveState: (payload) => ipcRenderer.invoke('bid-document:save-state', payload),
    validate: (payload) => ipcRenderer.invoke('bid-document:validate', payload),
    selectAsset: (options) => ipcRenderer.invoke('bid-document:select-asset', options),
    analyzeReference: (options) => ipcRenderer.invoke('bid-document:analyze-reference', options),
    exportTemplateInfo: (options) => ipcRenderer.invoke('bid-document:export-template-info', options),
    exportProjectConfig: (options) => ipcRenderer.invoke('bid-document:export-project-config', options),
    exportReadinessReport: (options) => ipcRenderer.invoke('bid-document:export-readiness-report', options),
    exportAssetCollectionPackage: (options) => ipcRenderer.invoke('bid-document:export-asset-collection-package', options),
    importAssetCollectionPackage: (options) => ipcRenderer.invoke('bid-document:import-asset-collection-package', options),
    importProjectConfig: (options) => ipcRenderer.invoke('bid-document:import-project-config', options),
    exportWord: (options) => ipcRenderer.invoke('bid-document:export-word', options),
  },
  bidOpportunity: {
    ...
    addFollowUpRecord: (id, payload) => ipcRenderer.invoke('bid-opportunity:add-follow-up-record', id, payload),
    updateFollowUpRecord: (id, patch) => ipcRenderer.invoke('bid-opportunity:update-follow-up-record', id, patch),
    deleteFollowUpRecord: (id) => ipcRenderer.invoke('bid-opportunity:delete-follow-up-record', id),
    importAttachments: (id, options) => ipcRenderer.invoke('bid-opportunity:import-attachments', id, options),
    updateAttachment: (id, patch) => ipcRenderer.invoke('bid-opportunity:update-attachment', id, patch),
    deleteAttachment: (id) => ipcRenderer.invoke('bid-opportunity:delete-attachment', id),
