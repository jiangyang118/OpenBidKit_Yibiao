...
@click.option("--kind", type=click.Choice(["duplicate", "rejection"]), required=True, help="Report type to export.")
...
@click.option("--format", "report_format", type=click.Choice(["md", "docx", "pdf"]), default="md", show_default=True, help="Report output format.")
